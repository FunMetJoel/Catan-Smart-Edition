...
class secondNN(abstractCatanBot.CatanBot):
...
if __name__ == "__main__":
    ...
    bots = [secondNN(), secondNN(), secondNN(), secondNN()]
    totalScore = [0, 0, 0, 0]
    ...
    while True:
        ...
        if episode % 50 == 0:
            ...
            newBots:list[secondNN] = [secondNN(), secondNN(), secondNN(), secondNN()]
